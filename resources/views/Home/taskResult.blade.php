...
@section('script')
    ...
    <script>
        $(".pagination-demo").jqPaginator({
            ...
            visiblePages: 10,
            currentPage: {{$page}},
            first: '<li class="first"><a href="/taskshow/{{$id}}/1">首页<\/a><\/li>',
            prev: '<li class="prev"><a href="/taskshow/{{$id}}/@{{page}}">上一页<\/a><\/li>',
            next: '<li class="next"><a href="/taskshow/{{$id}}/@{{page}}">下一页<\/a><\/li>',
            last: '<li class="last"><a href="/taskshow/{{$id}}/@{{totalPages}}">末页<\/a><\/li>',
            page: '<li class="page"><a href="/taskshow/{{$id}}/@{{page}}">@{{page}}<\/a><\/li>',
